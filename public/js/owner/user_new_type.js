function createNewTypeTable (){
    if($('#newTypeCollapse').hasClass('drawTable')==false){
        $('#newTypeTable').DataTable({
        ajax:{
            type:'POST',
            url: owner_new_type_table_ajax_url,
            data: {'id':user_id},
            dataSrc: 'new_types'
        },
        columns: [
            ...
            },
            {
                ...
                render:function(row){
                    ...
                    if(row.role){
                        ...
                        +'onclick="changeIssueTime(\'new_type\',\''+row.id+'\',\''+row.issue_input+'\')"'
            ...
            },
            {
                ...
                render:function(row){
                    if(row.role){
                        ...
                        +'<a data-toggle="modal" data-target="#newTypeDropModal" '
                        +'onclick="newTypeDrop(\''+row.id+'\')"'
        ...
        $('#newTypeCollapse').addClass('drawTable');
    }
}
