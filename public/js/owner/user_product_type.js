function createProductTypeTable (){
    if($('#productTypeCollapse').hasClass('drawTable')==false){
        $('#productTypeTable').DataTable({
        ajax:{
            type:'POST',
            url: owner_product_type_table_ajax_url,
            data: {'id':user_id},
            dataSrc: 'product_types'
        },
        columns: [
            {
                title:'Ürün Türü',
            ...
            },
            {
                ...
                render:function(row){
                    ...
                    if(row.role){
                        ...
                        +'onclick="changeIssueTime(\'product_type\',\''+row.id+'\',\''+row.issue_input+'\')"'
            ...
            },
            {
                ...
                render:function(row){
                    ...
                    if(row.role){
                        ...
                        +'onclick="productTypeDrop(\''+row.id+'\')"'
        ...
        $('#productTypeCollapse').addClass('drawTable');
    }
}
