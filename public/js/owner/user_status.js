function createStatusTable (){
    if($('#statusCollapse').hasClass('drawTable')==false){
        $('#statusTable').DataTable({
        ajax:{
            type:'POST',
            url: owner_status_table_ajax_url,
            data: {'id':user_id},
            dataSrc: 'status'
        },
        columns: [
            ...
            },
            {
                ...
                render:function(row){
                    ...
                    if(row.role){
                        ...
                        +'onclick="changeIssueTime(\'status\',\''+row.id+'\',\''+row.issue_input+'\')"'
            ...
            },
            {
                ...
                render:function(row){
                    if(row.role){
                        ...
                        +'<a data-toggle="modal" data-target="#statusDropModal" '
                        +'onclick="statusDrop(\''+row.id+'\')"'
        ...
        $('#statusCollapse').addClass('drawTable');
    }
}
