        ...
        columns: [
            ...
            },
            {
                ...
                render:function(row){
                    ...
                    <a onclick="statusUpdate('${row.id}')" data-toggle="modal" data-target="#statusUpdateModal">
                    ...
                    if(row.using_item >0 ){
                        ...
                        <a onclick="statusDelete('${row.id}')" data-toggle="modal" data-target="#statusDeleteModal">
